...
internal static class SourcePluginJsonParser
{
    ...
    private static bool TryParsePermissionStyle(string? style, out CodeOrbitPermissionResponseStyle result)
    {
        result = CodeOrbitPermissionResponseStyle.ClaudeStyle;
        ...
        switch (style.ToLowerInvariant())
        {
            case "claude-style":
                ...
                return true;
            case "codex":
                result = CodeOrbitPermissionResponseStyle.Codex;
                return true;
            default:
                return false;
        }
